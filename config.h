...
static const char *lightdowncmd[]  = { "xbacklight", "-set", "10", NULL };
static const char *lightupcmd[]    = { "xbacklight", "-set", "100", NULL };
static const char *lockcmd[]       = { "slock", NULL };
static const char *mailcmd[]       = { "st", "-t", "mutt", "-e", "mutt", NULL };
static const char *muscmd[]        = { "st", "-t", "cmus", "-e", "cmus", NULL };
static const char *musnext[]       = { "cmus-remote", "--next", NULL };
static const char *muspause[]      = { "cmus-remote", "--pause", NULL };
static const char *musprev[]       = { "cmus-remote", "--prev", NULL };
...
static const char *voloffcmd[]     = { "amixer", "set", "Master", "toggle", NULL };
static const char *volupcmd[]      = { "amixer", "set", "Master", "2%+", NULL };
static const char *webcmd[]        = { "/usr/local/bin/run_browser", NULL };
