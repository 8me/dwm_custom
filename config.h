...
static const Rule rules[] = {
  ...
  { "Texmaker",      NULL,        NULL,          1 << 7,  False,       -1 },
...
static const char *irssicmd[]      = { "xterm", "-t", "irssi", "-e", "irssi", NULL };
static const char *lockcmd[]       = { "blurlock", NULL };
static const char *mailcmd[]       = { "thunderbird", NULL };
static const char *padcmd[]        = { "xterm", "-T", "scratchpad", "-g", "56x10-30+40", NULL };
static const char *rangercmd[]     = { "rxvt", "-T", "ranger","-e", "ranger", NULL };
...
static Key keys[] = {
  ...
  //{ MODKEY|ShiftMask,  XK_t,          spawn,           {.v = togglekbdcmd} },
  //{ MODKEY|ShiftMask,  XK_b,          spawn,           {.v = statusbarcmd} },
    TAGKEYS(                        XK_1,                      0)
    TAGKEYS(                        XK_2,                      1)
    TAGKEYS(                        XK_3,                      2)
    TAGKEYS(                        XK_4,                      3)
